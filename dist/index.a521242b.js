...
createChart(); // const inputValue = 7; // как пример
 // economicChart.data.labels = Array.from({length: inputValue}, (v, k) => (k + 1).toString()) // получаем массив ["1", "2", "3", "4", "5", "6", "7"] как хотели
