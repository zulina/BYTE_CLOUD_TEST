...
const storage = document.getElementById("storage"), storage_label = document.getElementById("storage_label"), transfer = document.getElementById("transfer"), transfer_label = document.getElementById("transfer_label"), hdd = document.getElementById("bunny_op_hdd"), ssd = document.getElementById("bunny_op_ssd"), multi = document.getElementById("scaleway_op_multi"), single = document.getElementById("scaleway_op_single");
...
function calc() {
    ...
    if (hdd.checked) data[1].price = data[1].storageHddPrice * storage.value + data[1].transferPrice * transfer.value;
    else data[1].price = data[1].storageSsdPrice * storage.value + data[1].transferPrice * transfer.value;
    data[1].price = data[1].price > data[1].maxPrice ? data[1].maxPrice : data[1].price;
    if (multi.checked) data[2].price = data[2].storageMultiPrice * (storage.value - data[2].freeGB < 0 ? 0 : storage.value - data[2].freeGB) + data[2].transferPrice * (transfer.value - data[2].freeGB < 0 ? 0 : transfer.value - data[2].freeGB);
    else data[2].price = data[2].storageSinglePrice * (storage.value - data[2].freeGB < 0 ? 0 : storage.value - data[2].freeGB) + data[2].transferPrice * (transfer.value - data[2].freeGB < 0 ? 0 : transfer.value - data[2].freeGB);
...
},{}]},["47Zjz","8ZNvh"], "8ZNvh", "parcelRequire30ab")
